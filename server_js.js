...
app.get("/api/debug", async (req, res) => {
  try {
    ...
    res.json({
      sample_deals: data.results.map(d => ({ name: d.properties.dealname, setter_owner_raw: d.properties.setter_owner })),
      owners: owners.results.map(o => ({ id: o.id, userId: o.userId, email: o.email, name: `${o.firstName} ${o.lastName}` })),
    });
  } catch(e) {
